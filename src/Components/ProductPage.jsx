...
const ProductPage = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <video alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={babaVideo} autoPlay loop />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="leading-relaxed mb-5">3 दिन में रिजल्ट मिल जाएगा 7-8 दिन में आप ठीक हो जाओगे। दवा गारंटी की रहेगी.</p>
    
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">₹2299.00</span>
          <button
